...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const transferVendorTransaction = await yourToken.transfer(
    vendor.address,
  ...
  console.log("\n 🏵  Sending 1000 tokens to the frontend address...\n");
  
  const transferFrontendTransaction = await yourToken.transfer(
    "0xAd01806419FFd5862559c6AA24F9D1a25BbD5dA6",
    ethers.utils.parseEther("1000")
  );
  ...
  const ownershipTransaction = await vendor.transferOwnership("0xAd01806419FFd5862559c6AA24F9D1a25BbD5dA6");
  console.log("\n    ✅ confirming...\n");
